...
internal static class ControllerErrorMapper
{
    ...
    /// <returns>HTTP action result containing errors.</returns>
    internal static IActionResult ToActionResult(this IReadOnlyList<FileError> errors)
    {
        ...
        return new ObjectResult(errors) { StatusCode = status };
    }
}
